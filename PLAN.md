...
- 2026-03-14 13:40 — Sprint 1.5 complete. Added: Admin auth (JWT), admin login endpoint, admin dashboard API (list/filter/search candidates), candidate self-service (unique token link), role-based access control, status update endpoint. 23/23 tests passing.
- 2026-03-14 14:15 — Bug fix: old DB missing submission_token column. Recreated DB.
- 2026-03-14 14:33 — Frontend fix: added candidate view (/application/:token), admin dashboard (/admin), admin login (/login), routing. 44/44 tests.
